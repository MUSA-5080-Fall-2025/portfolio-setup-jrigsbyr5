...
On log scale:
𝛽1 = change in log(expected count) per unit increase in 𝑋1
On count scale (exponentiate):
exp(𝛽1) = multiplicative effect on expected count
Examples:
𝛽	exp(𝛽)	Interpretation
