...
Breaking it down:
(𝑥𝑖−𝑥¯) = How far is my house’s error from the mean?
(𝑥𝑗−𝑥¯) = How far is my neighbor’s error from the mean?
Multiply them:
...
A main takeaway was that clustering and spatial autocorrelation could just be information that the model hasn’t captured yet, potentially a missing geographical variable, neighborhood effects, school districts, access to amenities etc. . Spatial statistics is less about eliminating patterns and more about understanding why those patterns exist.
